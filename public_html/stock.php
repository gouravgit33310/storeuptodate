...
<body>
  ...
  <div class="container">
     <form id="insertform" method="post">
      ...
      <input type="number" style="margin-top:20px; height:50px;" class="form-control border-primary" name="buyamt" id="buyamt" placeholder="Buy Amount">
...
// total amount code
   ...
   document.querySelector('#rate').addEventListener('keyup', function(e){
       ...
       let sumamt = rate * qwt;
       document.querySelector('#buyamt').value = sumamt;
   })
        ...
        form.addEventListener('submit', function(event) {
            ...
            let qwt = document.querySelector("#qwt").value;
            let buyamt = document.querySelector("#buyamt").value;
          ...
          alert("Please add unit");
            ...
            alert("Please add qwt");
               ...
               $.ajax({
                url: "backend_stock.php",
                type: "POST",
                data: {item: item, unit: unit, qwt: qwt, buyamt: buyamt},
                success: function(data){
                  if (data == 'success'){
